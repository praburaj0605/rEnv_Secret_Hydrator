...
- Cargo workspace with `env-secret-hydrator` façade and modular `esh-*` provider crates
...
- crates.io packaging: publish metadata, per-crate READMEs/licenses, checklist in `docs/PUBLISHING.md`
